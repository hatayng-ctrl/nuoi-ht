...
<body>
    ...
    <script>
        ...
        const CONFIG = {
            ...
            storyContent: `
                <p>Xin chào, tôi là một <span class="highlight">vibe developer</span> đang loay hoay giữa cuộc sống, code đến 3h sáng, debug đến <span class="highlight">hói đầu</span>, và fix bug đến <span class="highlight">mờ mắt</span>. Nhưng tôi cũng cần được yêu thương! 💔</p>
                <p>Mỗi đồng bạn donate sẽ giúp tôi:</p>
                <ul style="margin-top: 10px; margin-left: 20px;">
                    <li>🍜 Ăn phở thay vì mì gói</li>
                    <li>☕ Mua cà phê để thức code</li>
                    <li>💊 Mua thuốc nhỏ mắt (quan trọng!)</li>
                    <li>🎮 Thỉnh thoảng được chơi game</li>
                </ul>
            `,
            ...
            // ═══════════════════════════════════════════════════════════════════
            marqueeItems: [
                "🔥 BREAKING: Dev bỏ ăn trưa 7 ngày liên tục để code dự án này!",
                "🎮 Fun fact: 99% donate sẽ đi vào game và phở (mostly phở)",
                "📊 Thống kê: 420 người xem, 69 người cười, 0 người donate",
                "☕ Đang cần gấp cà phê để fix bug nghiêm trọng (game lag)",
                "🏆 TOP DONOR: Anonymous - 500k | Lời nhắn: \"Code đẹp đấy, ăn đi em\"",
            ],
            ...
            donationOptions: [
                {
                    amount: 10000,
                    emoji: "🥤",
                    description: "Đợi mh 10p ",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/oQeZ8nBm7qoQbpZ"
                },
                {
                    amount: 29000,
                    emoji: "🍜",
                    description: "Đợi mh 30p",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/WPe99NwLV3w4eLy"
                },
                {
                    amount: 50000,
                    emoji: "☕",
                    description: "Đợi mh 1 tiếng",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/BDbDqoLJmA8ydl2",
                    isDefault: true  // Mức mặc định được chọn sẵn
                },
                {
                    amount: 100000,
                    emoji: "🍕",
                    description: "Đợi mh 3 tiếng",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/APdRlJq5EAgYaGy"
                },
                {
                    amount: 200000,
                    emoji: "🎮",
                    description: "Đợi mh 6 tiếng",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/X7ax6xE7JR19dyv"
                },
                {
                    amount: 500000,
                    emoji: "💎",
                    description: "Đợi mh ∞ ngày",
                    momoLink: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3/zPdywyGJV2gEaQr"
                }
            ],
            
            // Link MoMo mặc định (khi không tìm thấy amount phù hợp)
            momoFallback: "https://me.momo.vn/pwI4TzsVu3FgtnuxFvsot3",
